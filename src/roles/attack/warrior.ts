...
export class RoleWarrior extends Role {
    ...
    finalTargetId: Id<Structure | Creep>;
    nowTargetId: Id<Structure | Creep>;
    ...
    run() {
        ...
        let target: Structure | Creep | null = Game.getObjectById<Structure>(this.finalTargetId);
        ...
        let nowTarget: Structure | Creep | null = Game.getObjectById<Structure>(this.nowTargetId);
        // if(!nowTarget) {
